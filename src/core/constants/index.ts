...
export const DOMAIN_SEPARATORS: Record<string, string> = {
...
export const ERC721_ABI = ['function ownerOf(uint256) external view returns (address)'];

export const ERC20_ABI = ['function balanceOf(address) external view returns (uint256)'];
